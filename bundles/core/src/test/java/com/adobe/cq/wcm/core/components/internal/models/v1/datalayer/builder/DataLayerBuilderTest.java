...
public final class DataLayerBuilderTest {
    ...
    class ComponentDataBuilders {
        ...
        void extendingComponent() {
            ...
            ComponentData extendedDataNoOverlay = DataLayerBuilder.extendingComponent(
            ...
            ComponentData componentData = DataLayerBuilder.extendingComponent(originalData)
    ...
    class ContainerDataBuilders {
        ...
        void extendingContainer() {
            ...
            // wrap the component data without changing any values
            ContainerData extendedDataNoOverlay = DataLayerBuilder.extendingContainer(
                initialBuilder.build()
            ).build();
            ...
            // wrap the component data and change every value
            ContainerData componentData = DataLayerBuilder.extendingContainer(originalData)
                // the effective values
                .withId(() -> TEST_ID)
                .withDescription(() -> TEST_DESCRIPTION)
                .withLastModifiedDate(() -> LAST_MODIFIED_DATE)
    ...
    class ImageDataBuilders {
        ...
        void extendingImage() {
            ...
            // wrap the component data without changing any values
            ImageData extendedDataNoOverlay = DataLayerBuilder.extendingImageComponent(
                initialBuilder.build()
            ).build();
            ...
            // wrap the component data and change every value
            ImageData componentData = DataLayerBuilder.extendingImageComponent(originalData)
                // the effective values
                .withId(() -> TEST_ID)
                .withDescription(() -> TEST_DESCRIPTION)
                .withLastModifiedDate(() -> LAST_MODIFIED_DATE)
    ...
    class PageDataBuilders {
        ...
        void extendingPage() {
            ...
            // wrap the component data without changing any values
            PageData extendedDataNoOverlay = DataLayerBuilder.extendingPage(
                initialBuilder.build()
            ).build();
            ...
            // wrap the component data and change every value
            PageData componentData = DataLayerBuilder.extendingPage(originalData)
                // the effective values
                .withId(() -> TEST_ID)
                .withDescription(() -> TEST_DESCRIPTION)
                .withLastModifiedDate(() -> LAST_MODIFIED_DATE)
